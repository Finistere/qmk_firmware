...
[_QWERTY] = SPLIT_LAYOUT(
         ...
         KC_EQUAL,             KC_A,             KC_S,             KC_D,             KC_F,             KC_G,
          KC_LSFT,             KC_Z,             KC_X,             KC_C,             KC_V,             KC_B,         TG(_GAMING),
 ...
 *               `-----------------------------------'    '-----------------------------------'
 */
[_GAMING] = SPLIT_LAYOUT(
          _______,          _______,          _______,          _______,          _______,          _______,
          _______,          _______,          _______,          _______,          _______,          _______,
          KC_LCTL,          _______,          _______,          _______,          _______,          _______,
          _______,          _______,          _______,          _______,          _______,          _______,          _______,
                                              KC_LCTL,          KC_LALT,          XXXXXXX,         KC_SPACE, MO(_GAMING_FUNC),
// --------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----
                            _______,          _______,          _______,          _______,          _______,          _______,
                            _______,          _______,          _______,          _______,          _______,          _______,
                            _______,          _______,          _______,          _______,          _______,          _______,
          _______,          _______,          _______,          _______,          _______,          _______,          _______,
          KC_BSPC,           KC_ENT,          KC_LEFT,          KC_DOWN,          KC_RIGHT
    ),
/*
 * _GAMING_FUNC
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 *               `-----------------------------------'    '-----------------------------------'
 */
[_GAMING_FUNC] = SPLIT_LAYOUT(
          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,
          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,
          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,
          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,
                                              XXXXXXX,          XXXXXXX,           KC_ESC,          XXXXXXX,          XXXXXXX,
// --------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|-----
                            XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,
                            XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,
                            XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,          XXXXXXX,
...
[_GAMING_FUNC]  = { ENCODER_CCW_CW(_______, _______),       ENCODER_CCW_CW(_______, _______)       },
};
